...
public class Beaver extends MovingBot {
  public static final RobotType[] types = {RobotType.MINERFACTORY, RobotType.HELIPAD, RobotType.BARRACKS, 
    RobotType.TANKFACTORY, RobotType.SUPPLYDEPOT, RobotType.TECHNOLOGYINSTITUTE, RobotType.TRAININGFIELD, RobotType.AEROSPACELAB};
